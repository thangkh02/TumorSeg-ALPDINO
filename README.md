...
Phương Pháp Luận Nghiên Cứu Khoa Học (2025)  
...
**Độ Ổn Định**
- ALPNet: Giảm 11.7% khi chuyển từ 5-shot sang 1-shot
- DINO-ALPNet: Giảm chỉ 3.2%

DINOv2 cung cấp biểu diễn đặc trưng mạnh mẽ hơn, ít phụ thuộc vào lượng dữ liệu mẫu.
...
![Segmentation Results Comparison](./images/segmentation_results.png)
...
![BraTS 2023 Dataset Examples](./images/dataset_samples.png)
...
- Nén mô hình (model compression) để giảm 86M sang ~30-40M tham số
...
Báo cáo chi tiết: [Báo cáo.pdf](./Báo%20cáo.pdf)
...
- Bộ dữ liệu: https://www.med.upenn.edu/cbica/brats2023/
- DINOv2: https://dinov2.metademolab.com/
- ALPNet: https://github.com/PAD13/ALPNet
